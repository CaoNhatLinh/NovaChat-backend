...
import com.chatapp.chat_service.model.dto.MessageAttachmentDto;
import com.chatapp.chat_service.model.dto.MessageReactionDto;
import com.chatapp.chat_service.model.dto.UserDTO;
import com.chatapp.chat_service.model.entity.*;
import com.chatapp.chat_service.repository.*;
import com.chatapp.chat_service.websocket.event.MessageReactionEvent;
import com.chatapp.chat_service.websocket.event.MessageReadEvent;
...
public class MessageEnhancementService {
    ...
    public void toggleReaction(UUID conversationId, UUID messageId, String emoji, UUID userId) {
        ...
        kafkaProducer.sendReactionEvent(event);
